...
import {
  FormControl_default,
  isFilled
} from "./chunk-L7YBAXYQ.js";
import {
  createSvgIcon
} from "./chunk-ZFAFI3NH.js";
import {
  Transition_default
} from "./chunk-RMTR64XD.js";
import {
  require_react_dom
} from "./chunk-6VWAHX6D.js";
import {
  capitalize_default
} from "./chunk-IEAHKHLL.js";
import {
  getOverlayAlpha_default,
  useTheme
} from "./chunk-NQ7XNMQR.js";
import {
  ...
  useTimeout
} from "./chunk-QARWKML6.js";
import {
  formControlState
} from "./chunk-PR6ZCO7G.js";
import {
  useControlled_default
} from "./chunk-MGD5EACB.js";
import {
...
import {
  useForkRef_default
} from "./chunk-ABR6QGGQ.js";
import {
  useDefaultProps
} from "./chunk-SGNJS4LX.js";
import {
  setRef,
  useForkRef,
  useId
} from "./chunk-KPQPK7NU.js";
import {
  _extends,
...
var ListContext = React11.createContext({});
if (true) {
...
var List = React12.forwardRef(function List2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiList"
  });
  ...
  return (0, import_jsx_runtime15.jsx)(ListContext_default.Provider, {
    value: context,
    children: (0, import_jsx_runtime14.jsxs)(ListRoot, _extends({
      as: component,
      className: clsx_default(classes.root, className),
      ref,
      ownerState
...
var MenuList = React13.forwardRef(function MenuList2(props, ref) {
  ...
  return (0, import_jsx_runtime16.jsx)(List_default, _extends({
    role: "menu",
    ref: handleRef,
    className,
...
var Portal = React16.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime20.jsx)(React16.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime20.jsx)(React16.Fragment, {
...
var Backdrop = React18.forwardRef(function Backdrop2(inProps, ref) {
  ...
  return (0, import_jsx_runtime22.jsx)(TransitionComponent, _extends({
    ...
    children: (0, import_jsx_runtime22.jsx)(BackdropRoot, _extends({
      "aria-hidden": true
    }, rootSlotProps, {
...
var Modal = React20.forwardRef(function Modal2(inProps, ref) {
  ...
  return (0, import_jsx_runtime23.jsx)(Portal_default, {
    ...
    container,
    disablePortal,
    children: (0, import_jsx_runtime24.jsxs)(RootSlot, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime23.jsx)(BackdropSlot, _extends({}, backdropProps)) : null, (0, import_jsx_runtime23.jsx)(FocusTrap_default, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
...
var Paper = React21.forwardRef(function Paper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime25.jsx)(PaperRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
...
var Popover = React22.forwardRef(function Popover2(inProps, ref) {
  ...
  return (0, import_jsx_runtime26.jsx)(RootSlot, _extends({}, rootProps, !isHostComponent_default(RootSlot) && {
    slotProps: rootSlotPropsProp,
    disableScrollLock
  }, {
...
var _excluded19 = ["className", "disabled", "error", "IconComponent", "inputRef", "variant"];
...
var NativeSelectInput = React24.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime29.jsxs)(React24.Fragment, {
    children: [(0, import_jsx_runtime28.jsx)(NativeSelectSelect, _extends({
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref
    }, other)), props.multiple ? null : (0, import_jsx_runtime28.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
var _span3;
var _excluded20 = ["aria-describedby", "aria-label", "autoFocus", "autoWidth", "children", "className", "defaultOpen", "defaultValue", "disabled", "displayEmpty", "error", "IconComponent", "inputRef", "labelId", "MenuProps", "multiple", "name", "onBlur", "onChange", "onClose", "onFocus", "onOpen", "open", "readOnly", "renderValue", "SelectDisplayProps", "tabIndex", "type", "value", "variant"];
...
var SelectInput = React25.forwardRef(function SelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime31.jsxs)(React25.Fragment, {
    children: [(0, import_jsx_runtime30.jsx)(SelectSelect, _extends({
    ...
    })), (0, import_jsx_runtime30.jsx)(SelectNativeInput, _extends({
      "aria-invalid": error,
      ...
      autoFocus,
      ownerState
    }, other)), (0, import_jsx_runtime30.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime30.jsx)(Menu_default, _extends({
      id: `menu-${name || ""}`,
...
var Select = React27.forwardRef(function Select2(inProps, ref) {
  ...
  const InputComponent = input || {
    standard: (0, import_jsx_runtime33.jsx)(StyledInput, {
      ownerState
    }),
    outlined: (0, import_jsx_runtime33.jsx)(StyledOutlinedInput, {
      label,
      ownerState
    }),
    filled: (0, import_jsx_runtime33.jsx)(StyledFilledInput, {
      ownerState
    })
  }[variant];
  const inputComponentRef = useForkRef_default(ref, InputComponent.ref);
  return (0, import_jsx_runtime33.jsx)(React27.Fragment, {
    children: React27.cloneElement(InputComponent, _extends({
...
var TextField = React28.forwardRef(function TextField2(inProps, ref) {
  ...
  const InputElement = (0, import_jsx_runtime34.jsx)(InputComponent, _extends({
  ...
  return (0, import_jsx_runtime35.jsxs)(TextFieldRoot, _extends({
    className: clsx_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    children: [label != null && label !== "" && (0, import_jsx_runtime34.jsx)(InputLabel_default, _extends({
      htmlFor: id,
      id: inputLabelId
    }, InputLabelProps, {
      children: label
    })), select ? (0, import_jsx_runtime34.jsx)(Select_default, _extends({
      "aria-describedby": helperTextId,
      id,
      ...
      children
    })) : InputElement, helperText && (0, import_jsx_runtime34.jsx)(FormHelperText_default, _extends({
      id: helperTextId
    }, FormHelperTextProps, {
      children: helperText
    }))]
