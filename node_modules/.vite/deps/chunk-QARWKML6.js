...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime8.jsxs)(React20.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime8.jsxs)(React20.Fragment, {
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React22.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React22.forwardRef(function Grid3(inProps, ref) {
    ...
    const overflow2 = React22.useContext(GridOverflowContext);
    const {
      className,
      children,
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-QARWKML6.js.map
